...
import { Leaf, Search, Brain, Sprout } from "lucide-react";

const PredictionLoader = ({ message = "Analyzing your plant..." }) => {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-green-50 to-emerald-50">
      <div className="text-center max-w-md mx-auto">
        ...
        {/* Additional prediction-specific elements */}
        <div className="space-y-2 text-sm text-gray-500">
          <p className="animate-pulse flex items-center justify-center gap-2">
            <Search size={16} className="text-green-600" />
            <span>Processing image...</span>
          </p>
          <p className="animate-pulse delay-[500ms] flex items-center justify-center gap-2">
            <Brain size={16} className="text-green-600" />
            <span>Running AI analysis...</span>
          </p>
          <p className="animate-pulse delay-[1000ms] flex items-center justify-center gap-2">
            <Sprout size={16} className="text-green-600" />
            <span>Identifying plant features...</span>
          </p>
        </div>
      </div>
    </div>
