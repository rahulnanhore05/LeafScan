...
import { Stethoscope, Microscope, Activity, Pill } from "lucide-react";

const DiagnosisLoader = ({ message = "Diagnosing plant health..." }) => {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-green-50 to-emerald-50">
      <div className="text-center max-w-md mx-auto">
        ...
        {/* Additional diagnosis-specific elements */}
        <div className="space-y-2 text-sm text-gray-500">
          <p className="animate-pulse flex items-center gap-2">
            <Microscope size={16} className="text-green-600" />
            <span>Examining symptoms...</span>
          </p>
          <p className="animate-pulse delay-[500ms] flex items-center gap-2">
            <Activity size={16} className="text-green-600" />
            <span>Running health analysis...</span>
          </p>
